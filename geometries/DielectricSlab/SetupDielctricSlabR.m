...
sim_setup.FDTD.PML = 2; % use pml with 8 cells thickness, "2" would be MUR
...
sim_setup.Geometry.MeshResolution = [30, 30,30];
...
m2.Type = 'Material';
m2.Properties.Epsilon = 1;
m2.Properties.Kappa = 0.05;
materials{2} = m2;
rMaterial = m2;
sim_setup.PP.rEpsilon = m2.Properties.Epsilon;
sim_setup.PP.rKappa   = m2.Properties.Kappa;
