...
R30 = 0.001;
R300 = 0.01;
mRSheetI.Properties.Thickness = 0;
mRSheetI.Properties.Kappa = mRSheetI.Properties.Thickness*sim_setup.Geometry.Unit/R30;
mRSheetI.Name = '30OhmResistor';
mRSheetI.Type = 'ConductingSheet';

mRSheetO.Properties.Thickness = 0;
mRSheetO.Properties.Kappa = mRSheetO.Properties.Thickness*sim_setup.Geometry.Unit/R300;
