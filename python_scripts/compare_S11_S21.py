...
ax1.plot(d1[:,0]/1e9, abs(d1[:,1]+1j*d1[:,2])**2, "r-", label=args.label1+" S11")
ax1.plot(d2[:,0]/1e9, abs(d2[:,1]+1j*d2[:,2])**2, "r--", label=args.label2+" S11")
ax1.plot(d1[:,0]/1e9, abs(d1[:,3]+1j*d1[:,4])**2, "b-", label=args.label1+" S21")
ax1.plot(d2[:,0]/1e9, abs(d2[:,3]+1j*d2[:,4])**2, "b--", label=args.label2+" S21")
